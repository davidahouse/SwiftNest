...
class ListDialogViewController: NSViewController {
    ...
    private func setupTable() {
        ...
        for columnIndex in 1...model.numberOfColumns() {

            let column = NSTableColumn(identifier: NSUserInterfaceItemIdentifier(rawValue: "\(columnIndex)"))
            column.title = model.columnName(column: columnIndex)
